    ...
    <div id="user_form">
        <div class="card of-hide shadow-sm">
            ...
            <div class="card-body pt-3">
                ...
                <form class="form-horizontal" form method="post" action="{{ route('users.store') }}" enctype="multipart/form-data">
                    @csrf
    
                    <div class="form-group row mb-3">
                        <label class="col-sm-4 col-form-label">Name :</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Name" name="name" value="{{ old('name') }}" autocomplete="on">
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="email" class="email form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Email" id="email" name="email" value="{{ old('email') }}">
                            @if ($errors->has('email'))
                            <span class="invalid-feedback" role="alert">
